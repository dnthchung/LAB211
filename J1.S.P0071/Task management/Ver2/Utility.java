...
//        if(meow.equalsIgnoreCase("code")||meow.equalsIgnoreCase("test")||meow.equalsIgnoreCase("design")||meow.equalsIgnoreCase("review")){
...
//    }
    ...
    public String getTaskTypeInput() {
        String taskType = getString("Task type: ", "Please input again", "Code|Test|Design|Review");
        return taskType;
    }
    //getInt("Task type: ", "Input must be 1,2,3 or 4", "Input must be 1,2,3 or 4", "Input must be INT", 1, 4);
