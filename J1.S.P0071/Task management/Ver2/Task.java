...
public class Task {
    ...
    public Task(String name, String date, String taskType, double from, double to, String assignee, String reviewer) {
        this.id = auto_tang++;
        this.name = name;
        this.date = date;
...
//  "ID","Name","Task Type","Date","Time","Assignee","Reviewer");
        return String.format("%-15s %-20s %-15s %-15s %-15s %-15s %-15s "
                , id, name, taskType, date, getTimeInput(from, to), assignee, reviewer);
